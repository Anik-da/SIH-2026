...
const GLOBAL_LOCATIONS = [
  ...
  { name: 'Shanghai, China (3D Urban Twin)', type: 'Global 3D Digital Twin', lat: 31.2397, lon: 121.4998, height: 1100 },
  { name: '🗽 New York City, USA (Photorealistic 3D Mesh)', type: 'Exclusive Photorealistic 3D Twin', lat: 40.7128, lon: -74.0060, height: 1000 },
