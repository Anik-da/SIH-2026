...
export const VerticalFloorSlider: React.FC<Props> = ({
  ...
  return (
    <div className="pointer-events-auto absolute left-24 top-4 z-20 flex flex-col items-center gap-1.5 rounded-2xl border border-slate-800 bg-slate-900/85 p-2 shadow-xl backdrop-blur-md">
